...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_TRACKBALL] = LAYOUT( //07
      //,-----------------------------------------------------.                    ,-----------------------------------------------------.
          _______, _______, MS_BTN4,  SCROLL, MS_BTN5, _______,                      _______, _______, _______, _______, _______, _______,
      //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
          _______, COMMENT, MS_BTN3, MS_BTN2, MS_BTN1,  KC_DEL,                      _______, _______, _______, _______, _______, _______,
      //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
...
const uint16_t PROGMEM touhou[]       = { KC_SCLN, CS_HASH,  KC_ESC,          COMBO_END};
const uint16_t PROGMEM steno[]        = { KC_SCLN, CS_HASH,    KC_A, TABRSFT, COMBO_END};
const uint16_t PROGMEM numpad[]       = {    KC_U, KC_SCLN, CS_HASH,          COMBO_END};
const uint16_t PROGMEM mouse[]        = {    KC_A, DOT_QUE,                   COMBO_END};
const uint16_t PROGMEM mouse2[]       = {    KC_N,    KC_Q,                   COMBO_END};
...
const uint16_t PROGMEM l_exponent[]   = {    KC_L,    KC_D,                   COMBO_END};
const uint16_t PROGMEM l_comma[]      = {    KC_T,    KC_W,                   COMBO_END};
const uint16_t PROGMEM l_dot[]        = {    KC_R,    KC_T,                   COMBO_END};
const uint16_t PROGMEM l_underscore[] = {    KC_M,    KC_W,                   COMBO_END};
const uint16_t PROGMEM l_asterisk[]   = {    KC_S,    KC_V,                   COMBO_END};
const uint16_t PROGMEM l_equals[]     = {    KC_D,    KC_C,                   COMBO_END};
const uint16_t PROGMEM l_plus[]       = {    KC_S,    KC_G,                   COMBO_END};
const uint16_t PROGMEM l_minus[]      = {    KC_T,    KC_S,                   COMBO_END};
const uint16_t PROGMEM l_newsent[]    = {    KC_X,    KC_T,                   COMBO_END};
const uint16_t PROGMEM exclamation[]  = {    KC_R,    KC_D,                   COMBO_END};
const uint16_t PROGMEM colon[]        = {    KC_D,    KC_S,                   COMBO_END};
...
const uint16_t PROGMEM spc_f1[]       = {  KC_SPC,    KC_Z,                   COMBO_END};
const uint16_t PROGMEM spc_f2[]       = {  KC_SPC,    KC_L,                   COMBO_END};
const uint16_t PROGMEM spc_f3[]       = {  KC_SPC,    KC_D,                   COMBO_END};
const uint16_t PROGMEM spc_f4[]       = {  KC_SPC,    KC_C,                   COMBO_END};
const uint16_t PROGMEM spc_f5[]       = {  KC_SPC,    KC_B,                   COMBO_END};

const uint16_t PROGMEM spc_1[]        = {  KC_SPC,    KC_N,                   COMBO_END};
const uint16_t PROGMEM spc_2[]        = {  KC_SPC,    KC_R,                   COMBO_END};
const uint16_t PROGMEM spc_3[]        = {  KC_SPC,    KC_T,                   COMBO_END};
const uint16_t PROGMEM spc_4[]        = {  KC_SPC,    KC_S,                   COMBO_END};
const uint16_t PROGMEM spc_5[]        = {  KC_SPC,    KC_G,                   COMBO_END};
const uint16_t PROGMEM spc_6[]        = {  KC_SPC,    KC_Q,                   COMBO_END};
const uint16_t PROGMEM spc_7[]        = {  KC_SPC,    KC_X,                   COMBO_END};
const uint16_t PROGMEM spc_8[]        = {  KC_SPC,    KC_M,                   COMBO_END};
const uint16_t PROGMEM spc_9[]        = {  KC_SPC,    KC_W,                   COMBO_END};
const uint16_t PROGMEM spc_0[]        = {  KC_SPC,    KC_V,                   COMBO_END};

const uint16_t PROGMEM bspc_1[]       = {  CS_RT1,    KC_H,                   COMBO_END};
...
const uint16_t PROGMEM bspc_0[]       = {  CS_RT1,    KC_A,                   COMBO_END};
...
static inline void apply_mark_mods(void) {
    arrow_update_mods(mark_active ? MOD_BIT_LSHIFT : 0x00, 0x00);
}

static inline void apply_ctrl_lock_mods(void) {
    uint8_t mods = MOD_BIT_LCTRL | (mark_active ? MOD_BIT_LSHIFT : 0x00);
    arrow_update_mods(mods, 0x00);
}

static inline void apply_conditional_mod(bool condition, uint8_t mod_bit) {
    arrow_update_mods(condition ? mod_bit : 0x00, 0x00);
}

static bool process_arrow_key(uint16_t keycode, keyrecord_t* record) {
    ...
    if (arrow_state.ctrl_active) {
        ...
        bool is_retrigger = (arrow_state.last_key == arrow) && (delay <= 150);
        if (!is_retrigger) {
            arrow_state.last_key = arrow;
            apply_ctrl_lock_mods();
            return false;
        }
    }
...
static const keymatch_rule_t match_rules[] = {
    ...
    { LEFT,   { JUST, KC_I    }, { JUST, KC_T   }, /*i*/".e. ",   { true, KC_SPC,  4 } },
